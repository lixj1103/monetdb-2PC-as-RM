...
typedef int (*log_retry_end_fptr) (void);
typedef int (*log_sequence_fptr) (int seq, lng id);
typedef int (*log_prepare_fptr) (void);
typedef int (*log_abort_fptr) (void);
typedef int (*log_retry_abort_fptr) (void);
...
typedef struct logger_functions {
	...
	log_retry_end_fptr log_retry_end;/* add log_retry_end */
	log_prepare_fptr log_prepare;  /* add log_prepare */
	log_abort_fptr log_abort;    /* add log_abort */
	log_retry_abort_fptr log_retry_abort;/* add log_retry_end */
...
extern int sql_trans_commit(sql_trans *tr, int redo_log_off );
extern int sql_trans_prepare(sql_trans *tr, int redo_log_off );
extern int sql_trans_commit_prepare(sql_trans *tr, int redo_log_off );
extern int sql_trans_retry_commit_prepare(sql_trans *tr, int redo_log_off);
extern int sql_trans_abort_prepare(sql_trans *tr);
extern int sql_trans_retry_abort_prepare(sql_trans *tr);
...
extern sql_table *sql_trans_alter_table_type(sql_trans *tr, sql_table *t, int type);
...
extern sql_table *trans_rename_table( sql_trans * tr, const char *sname, const char *tname, const char *tnewname );
#endif /*SQL_STORAGE_H */
